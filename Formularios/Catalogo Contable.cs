        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    CargarDatos(); // Asumiendo que este método recarga los datos en el DataGridView o similar
                    LimpiarCampos(); // Asumiendo que este método limpia los campos después de guardar
                }
                else
                {
